...
class TColor {
  static Color get primary => const Color(0xFF79DEF4);
  ...
  static Color get crott => const Color(0xFF201F79).withOpacity(0.4);
  static Color get BACK => const Color(0xFF1565C0).withOpacity(0.4);
