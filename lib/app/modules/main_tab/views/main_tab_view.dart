...
class _MainTabViewState extends State<MainTabView>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        color: TColor.crott, // Sesuaikan dengan warna yang diinginkan
        backgroundColor: Colors.transparent, // Ubah sesuai kebutuhan
        buttonBackgroundColor: Colors.white, // Warna latar belakang tombol
  ...
  Widget _buildIcon(IconData icon, int index) {
    return Icon(
      icon,
      color: controller?.index == index ? TColor.primary : Colors.white,
    );
  }
}
